...
const Services = () => {
  ...
  const mainCard =
    "font-Gudea my-4 border-b-[1px] border-neutral-900 py-4 text-base text-white/60 md:text-lg";
  const head =
        ...
        <div className="grid place-content-between">
          <div className="relative mt-4 flex flex-col justify-center py-10">
            <h1 className="font-Fira mb-2 w-full pb-2 text-4xl font-bold capitalize md:text-5xl lg:text-6xl lg:leading-[50px]">
              Skills ranging from data analysis to web development.
            </h1>
            <p className={main}>
        ...
        <CardTilt className="rounded-2xl border-[1px] border-neutral-800 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-900 via-black to-neutral-900 px-10 py-4">
          ...
          >
            ...
            <p className={mainCard}>
              ...
              <br />
              <Chip
                className="font-Gudea my-4 mr-1 bg-purple-900 py-2 text-sm md:text-base"
                style={{
                  transform: "translateZ(50px)",
                }}
              >
          ...
          >
            ...
            <p className={mainCard}>
              ...
              <br />
              <Chip
                className="font-Gudea my-4 mr-1 bg-blue-900 py-2 text-sm md:text-base"
                style={{
                  transform: "translateZ(50px)",
                }}
              >
          ...
          >
            ...
            <p className="font-Gudea my-4 py-4 text-base text-white/60 md:text-lg">
              ...
              <br />
              <Chip
                className="font-Gudea my-4 mr-1 bg-emerald-900 py-2 text-sm md:text-base"
                style={{
                  transform: "translateZ(50px)",
                }}
              >
